...
import { FaBook, FaTree, FaRocket, FaPencilAlt, FaGraduationCap, FaSearch } from 'react-icons/fa';

const Navbar = () => {
  return (
    <div className="bg-gradient-to-br from-yellow-300 via-green-400 to-blue-500 text-indigo-900 overflow-hidden font-comic">
      <motion.nav
        initial={{ y: -100 }}
        animate={{ y: 0 }}
